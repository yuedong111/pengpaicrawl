...
class pengpai(scrapy.spiders.Spider):
    ...
    start_urls = [
        "https://www.thepaper.cn/load_index.jsp?nodeids=25434,25436,25433,25438,25435,25437,27234,25485,25432,37978,&topCids=2734118,2732678,2728847",
        ...
        "https://www.thepaper.cn/load_sparker_masnory.jsp?nodeids=35571,35570,35572,47281,&topCids=2726603,2733929,2738766,2738685,2738488,2737005,",
    ...
    def start_requests(self):
        for item in self.start_urls:
            yield scrapy.FormRequest(
                url=item, headers=self.headers, callback=self.parse
            )
    ...
    def parse(self, response):
        ...
        while True:
            ...
            if r.text == "":
                ...
                yield scrapy.FormRequest(
                    new_url, headers=self.headers, callback=self.parse_title
                )
            page = page + 1
